...
| CON02 | Arquitectura de Microservicios  | El sistema debe implementarse bajo una **arquitectura de microservicios**, donde cada módulo (reservas, pagos, usuarios, notificaciones, etc.) sea autónomo y desacoplado. |
...
| CON09 | Cache Distribuida Obligatoria   | Las funciones críticas de disponibilidad y reservas deben implementar **Redis** como sistema de cache distribuido para reducir latencia en horarios pico.   |
